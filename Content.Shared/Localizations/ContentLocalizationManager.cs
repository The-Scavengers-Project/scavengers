...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        private const string Culture = "ru-RU";// SC14-Localization
        private const string FallbackCulture = "en-US"; // SC14-Localization
        ...
        public void Initialize()
        {
            ...
            var fallbackCulture = new CultureInfo(FallbackCulture); // SC14-Localization

            _loc.LoadCulture(culture);
            _loc.LoadCulture(fallbackCulture); // SC14-Localization
            _loc.SetFallbackCluture(fallbackCulture); // SC14-Localization
            _loc.AddFunction(culture, "MANY", FormatMany); // SC14-Localization: To prevent problems in auto-generated locale files
